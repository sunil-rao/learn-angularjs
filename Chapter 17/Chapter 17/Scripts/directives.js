...
.directive("compilation", function() {
        return {
            scope: {
                local: "@data"
            },
            restrict: "E",
            templateUrl: "compilation.html",
            transclude: true,
            compile: function(elem, attrs, transFn) {
                return function(scope, elements, attributes) {
                    var newScope = scope.$new();

                    newScope.item = scope.local;
...
.directive("directiveCtrl", function() {
    return {
            scope: {
                name: "@data"
            },
...
.directive("usingDirectiveCtrl", function() {
    return {
            scope: {},
            require: "^directiveCtrl",
            compile: function(element, attributes) {
                return function(scope, elem, attrs, ctrl) {
                    scope.data=ctrl.displayName();
                };
            },
            templateUrl: "controller.html"
        };
